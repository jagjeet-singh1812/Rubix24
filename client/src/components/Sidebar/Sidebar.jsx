...
const Sidebar = () => {
  return (
    <div>
      ...
      {/* Sidebar content */}
      <aside className="fixed top-0 left-3 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0">
        <a href="#">
          <img
          ...
          <nav>
            ...
            <Link to="/q&a">
              <a className="flex items-center px-4 py-2 mt-5 text-gray-600 transition-colors duration-300 transform rounded-md dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700">
                ...
                <span className="mx-4 font-medium">Q&A</span>
              </a>
            </Link>
            ...
            <Link to="/terms">
              <a className="flex items-center px-4 py-2 mt-5 text-gray-600 transition-colors duration-300 transform rounded-md dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700">
                ...
                <span className="mx-4 font-medium">Terms and Conditions</span>
              </a>
            </Link>
          </nav>
